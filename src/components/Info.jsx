...
const Info = () => {
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="about">
        ...
        <ul>
          <li>
            This platform is developed by two MCA Students. <br />
            Raj Kumar(MCA student at BHU) and Mahtab Alam(MCA student at Anurag
            ...
            <ol>
              ...
              <ul>
                ...
                <li>
                  Solving the Question using internet or books and writing the
                  solution
                </li>
              ...
              <ul>
                <b>Responsibilities:</b>
                <li>
                  Managing the authentication system, student dashboard, test
                  interface, admin dashboard, Backend APIs, Database,
                  Deployment, etc.
                </li>
              </ul>
            </ol>
          ...
          <li>
            This platform is designed for GATE Computer Science Engineering exam
            preparation. Students can take mock tests, analyze performance,
      ...
      <ul>
        ...
        <li>
          Call: <a href="tel:+918207644020">+91 8207644020</a>
        </li>
      </ul>
  ...
  >
    ...
    />
      ...
      <ol>
        <li>
          Join our Telegram Group to keep yourself updated about upcoming test
          series.( <a href="https://t.me/c_programming_language1">Join now</a> )
        </li>
        <li>
          Join our WhatsApp Group to keep yourself updated about upcoming test
          series.({" "}
          <a href="https://chat.whatsapp.com/DWqT6jZXZkvGWP0U8mLrzd">
            Join now
          </a>{" "}
          )
        </li>
        <li>
          Discussion group.({" "}
          <a href="https://t.me/c_programming_language1">Join now</a> )
        </li>
      </ol>
      <hr />
